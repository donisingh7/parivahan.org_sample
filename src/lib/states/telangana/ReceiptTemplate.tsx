...
function EmblemWatermark() {
  return (
    ...
    >
      ...
      <img
        src={telanganaConfig.watermarkImage}
        alt=""
...
export default function TelanganaReceiptTemplate({ data }: { data: ReceiptData }) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ textAlign: "center", flex: 1, padding: "0 16px" }}>
          <div style={{ fontWeight: 900, fontSize: "15px", textDecoration: "underline" }}>
            {telanganaConfig.govLabel}
          </div>
          <div style={{ fontSize: "13px", marginTop: "2px" }}>{telanganaConfig.deptLabel}</div>
          <div style={{ fontSize: "12px", marginTop: "2px" }}>{telanganaConfig.receiptTitle}</div>
      ...
      {/* Field grid -- mirrors Telangana PDF layout */}
