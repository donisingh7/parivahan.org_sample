/**
 * Jharkhand PDF receipt generator. Each state has its own copy of this file
 * under src/lib/states/<state>/generateReceipt.js so the per-state design is
 * editable in isolation. The state-name strings ("GOVERNMENT OF JHARKHAND",
...
const STATE_GOV_LABEL    = 'GOVERNMENT OF JHARKHAND';
...
/**
 * Generates a Jharkhand checkpost tax receipt PDF and returns it as a Buffer.
