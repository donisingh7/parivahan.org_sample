/**
 * Himachal Pradesh PDF receipt generator — finalized two-page design.
 *  Page 1: HP logo | title | QR header, 11 field rows, first 2 tax items.
...
// ── Image watermark (HP logo, centre-right offset) ────────────────────────
...
async function generateReceipt(data) {
  ...
  const logoPath = path.join(process.cwd(), 'public', 'Images', 'HP_logo.png');
  ...
  // ── Tax table — page 1: first item only ─────────────────────────────
