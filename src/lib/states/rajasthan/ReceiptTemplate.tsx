...
function EmblemWatermark() {
  return (
    ...
    >
      ...
      <img
        src={rajasthanConfig.watermarkImage}
        alt=""
        style={{
          width: "260px",
          height: "auto",
      ...
      >
        ...
        <div style={{ textAlign: "center", flex: 1, padding: "0 16px" }}>
          <div style={{ fontWeight: 900, fontSize: "15px", textDecoration: "underline" }}>
            {rajasthanConfig.govLabel}
          </div>
          <div style={{ fontSize: "13px", marginTop: "2px" }}>{rajasthanConfig.deptLabel}</div>
          <div style={{ fontSize: "12px", marginTop: "2px" }}>{rajasthanConfig.receiptTitle}</div>
        </div>
