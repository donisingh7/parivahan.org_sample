...
// ── Main component ─────────────────────────────────────────────────────────
export default function OdishaReceiptTemplate({ data }: { data: ReceiptData }) {
        ...
        <tbody>
          <tr style={{ verticalAlign: "middle" }}>
            ...
            <td style={{ width: "60%", textAlign: "center", verticalAlign: "middle" }}>
              ...
              <div style={{ fontSize: "9px", fontWeight: "bold", marginTop: "3px" }}>Odisha Motor Vehicles Department</div>
