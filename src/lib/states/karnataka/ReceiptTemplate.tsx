...
// ── Main component ─────────────────────────────────────────────────────────
export default function KarnatakaReceiptTemplate({ data }: { data: ReceiptData }) {
        ...
        <tbody>
          <tr style={{ verticalAlign: "middle" }}>
            ...
            <td style={{ width: "60%", textAlign: "center", verticalAlign: "middle" }}>
              ...
              <div style={{ fontSize: "9px", fontWeight: "bold", marginTop: "3px" }}>Karnataka Motor Vehicles Department</div>
