...
// ── Image watermark (matches PDF: x=305 y=188, 230×265, opacity 0.40) ─────
function EmblemWatermark() {
  return (
    <div style={{
      ...
      <img
        src="/Images/Punjab_logo.png"
        alt=""
        style={{ width: "230px", height: "265px", objectFit: "contain" }}
...
function Field({ label, value }: { label: string; value: React.ReactNode }) {
  return (
    <div style={{ display: "flex", alignItems: "flex-start", marginBottom: "8px" }}>
      <div style={{ width: "120px", fontSize: "12px", fontWeight: 400, flexShrink: 0, lineHeight: 1.4, whiteSpace: "pre-line" }}>
        {label}
      </div>
      <div style={{ width: "12px", fontSize: "12px" }}>:</div>
  ...
  return (
    <div style={{ fontFamily: "Helvetica, Arial, sans-serif", color: "#000" }}>
      ...
      <div style={pageStyle}>
            ...
            <tr style={{ verticalAlign: "middle" }}>
              ...
              <td style={{ width: "20%", padding: "10px 5px" }}>
                ...
                <img
                  src="/Images/Punjab_logo.png"
                  alt=""
                  style={{ width: "100px", height: "120px", objectFit: "contain", background: "#fff" }}
                  onError={(e) => { e.currentTarget.style.display = "none"; }}
                />
              </td>
              {/* Titles */}
        ...
        {/* Two-column fields — 10 rows matching PDF field order */}
