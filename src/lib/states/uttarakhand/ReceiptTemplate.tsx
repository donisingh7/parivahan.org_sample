...
/**
 * Uttarakhand on-screen receipt — visually identical to the
 * GOVERNMENT OF UTTRAKHAND checkpost portal's "Checkpost Tax e-Receipt"
 * page (README.txt lines 3217-3614).
 *
 * Layout (matches the inspect HTML one-to-one):
 *   ┌────────────────────────────────────────────────────────────────────┐
 *   │  [UKBord]   GOVERNMENT OF UTTRAKHAND     Printed on : …    [QR]   │
 *   │             Department of Transport                                │
 *   │             Checkpost Tax e-Receipt                                │
 *   ├────────────────────────────────────────────────────────────────────┤
 *   │  Registration No.       : …    │  Receipt No.       : …            │
 *   │  Payment Init. Date     : …    │  Owner Name        : …            │
 *   │  Chassis No.            : …    │  Tax Mode          : …            │
 *   │  Vehilce Type           : …    │  Vehicle Class     : …            │
 *   │  Vehicle Category       : …    │  Mobile No.        : …            │
 *   │  Checkpost Name         : …    │  Seating Capacity  : …            │
 *   │  Sleeper Cap.           : 0    │  Bank Ref. No.     : …            │
 *   │  Payment Mode           : …    │  Permit Number     : …            │
 *   │  Permit Validity        : …    │  Fitness Validity  : …            │
 *   │  PUCC Validity          : …    │  Service Type      : …            │
 *   │  Permit Type            : …    │  Payment Confirm.  : …            │
 *   ├────────────────────────────────────────────────────────────────────┤
 ...
 *   └────────────────────────────────────────────────────────────────────┘
 *
 * "Vehilce Type" with the typo on line 3408 of the inspect HTML is preserved
 * verbatim — it's a real defect on the original portal but the user wants
 * pixel-parity with the source.
 */
...
// ── Center emblem (UKBord) — grey washed-out look like the original ──────
...
function EmblemWatermark() {
  return (
    ...
    >
      ...
      <img
        src={uttarakhandConfig.watermarkImage}
        alt=""
        style={{
          width: "320px",
          height: "auto",
  ...
  return (
    <tr>
      ...
      <td style={rowValueStyle}>
        : <span style={{ fontWeight: bold ? 700 : 400, marginLeft: 4 }}>
...
export default function UttarakhandReceiptTemplate({ data }: { data: ReceiptData }) {
  ...
  return (
    ...
    >
        ...
        <tbody>
          <tr style={{ verticalAlign: "middle" }}>
            ...
            <td style={{ width: "45%", textAlign: "center" }}>
              ...
              >
                {uttarakhandConfig.govLabel}
              </div>
              <div style={{ fontWeight: "bold", fontSize: "16px" }}>
                <b>{uttarakhandConfig.deptLabel}</b>
              </div>
              <div style={{ fontWeight: "bold", fontSize: "15px" }}>
                <b>{uttarakhandConfig.receiptTitle}</b>
              </div>
            </td>
      ...
      {/* Field grid — two columns × twelve rows, mirroring the inspect HTML */}
      <table
        style={{
          position: "relative",
          zIndex: 1,
            ...
            <td style={{ width: "50%", verticalAlign: "top" }}>
              <table style={{ width: "100%", borderCollapse: "collapse" }}>
                <tbody>
                  ...
                  <Row label="Vehilce Type"              value={data.vehicleType} />
                  ...
                  <Row label="Permit Validity"           value={data.permitValidityText} />
                  <Row label="PUCC Validity"             value={data.puccValidity} />
            ...
            <td style={{ width: "50%", verticalAlign: "top" }}>
              <table style={{ width: "100%", borderCollapse: "collapse" }}>
                <tbody>
                  ...
                  <Row label="Permit Number"       value={data.permitNumber} />
                  <Row label="Fitness Validity"    value={data.fitnessValidity} />
      ...
      {/* Tax breakup table — three rows for Uttarakhand */}
