...
function EmblemWatermark() {
  return (
    ...
    >
      ...
      <img
        src={chhattisgarhConfig.watermarkImage}
        alt=""
...
export default function ChhattisgarhReceiptTemplate({ data }: { data: ReceiptData }) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ textAlign: "center", flex: 1, padding: "0 16px" }}>
          <div style={{ fontWeight: 900, fontSize: "15px", textDecoration: "underline" }}>
            {chhattisgarhConfig.govLabel}
          </div>
          <div style={{ fontSize: "13px", marginTop: "2px" }}>{chhattisgarhConfig.deptLabel}</div>
          <div style={{ fontSize: "12px", marginTop: "2px" }}>{chhattisgarhConfig.receiptTitle}</div>
      ...
      {/* Field grid -- mirrors Chhattisgarh PDF layout */}
