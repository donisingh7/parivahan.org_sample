...
import { chhattisgarhConfig } from "@/lib/states/chhattisgarh/config";

const STATE_CODE  = chhattisgarhConfig.code;
const STATE_LABEL = chhattisgarhConfig.label;
...
function TaxCollectionContent() {
  ...
  const [cgLadenWeight,   setCgLadenWeight]   = useState("");
  const [cgUnladenWeight, setCgUnladenWeight] = useState("");
  ...
  const handleGetDetails = async () => {
    ...
    try {
      ...
      if (d.grossVehicleWt)  setCgLadenWeight(d.grossVehicleWt);
      if (d.unladenWt)       setCgUnladenWeight(d.unladenWt);
  ...
  const handleReset = () => {
    ...
    setCgLadenWeight(""); setCgUnladenWeight(""); setSeatingCap(""); setSleeperCap("0"); setServiceType("");
  ...
  const handleGetPdf = async () => {
    ...
    const receiptNo = `CGT${yy}${mm}${dd2}${rand}`;
    ...
    try {
      ...
      const link = document.createElement("a"); link.href=`/api/receipt/${savedId}?state=CG&download=1`; link.download=`receipt_${savedId}.pdf`; document.body.appendChild(link); link.click(); document.body.removeChild(link);
      ...
      <div className="cp-news-bar">
        <div className="container-fluid cp-news-scroll-wrap">
          <div className="cp-news-scroll">
            ...
            <strong className="cp-news-highlight">VAHAN CG CP &lt;VEHICLE NO&gt;</strong>
            &nbsp;to 7738299899
          </div>
        </div>
      </div>
                ...
                <div className="ui-panel-content">
                  ...
                  <div className="ui-grid-row">
                    <div className="ui-grid-col-6">
                      ...
                      <input type="text" className="ui-inputtext" maxLength={10}
                        ...
                        autoComplete="off" placeholder="e.g. CG04AB1234" />
                    </div>
                    <div className="ui-grid-col-6">
                      <div className="ui-grid-row">
                  ...
                  <div className="ui-grid-row">
                    <div className="ui-grid-col-6">
                      ...
                      <input type="text" className="ui-inputtext input-autofilled"
                        value={isGoodsVehicle ? cgLadenWeight : seatingCap}
                        onChange={(e) => isGoodsVehicle
                          ? setCgLadenWeight(e.target.value)
                    ...
                    <div className="ui-grid-col-6">
                      ...
                      <input type="text" className="ui-inputtext input-autofilled"
                        value={isGoodsVehicle ? cgUnladenWeight : sleeperCap}
                        onChange={(e) => isGoodsVehicle
                          ? setCgUnladenWeight(e.target.value)
