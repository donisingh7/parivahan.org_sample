...
import { gujaratConfig } from "@/lib/states/gujarat/config";

const STATE_CODE  = gujaratConfig.code;
const STATE_LABEL = gujaratConfig.label;
...
// Gujarat's checkpost-name list (web-sourced inter-state / RTO checkposts).
const CHECKPOST_OPTIONS = [
  { value: "",                     label: "---Select Checkpost Name---" },
  { value: "BHILAD",               label: "BHILAD" },
  { value: "SHAMLAJI",             label: "SHAMLAJI" },
  { value: "RATANPUR",             label: "RATANPUR" },
  { value: "AMIRGADH",             label: "AMIRGADH" },
  { value: "WAGHAI",               label: "WAGHAI" },
  { value: "SONGADH",              label: "SONGADH" },
  { value: "UMARGAM",              label: "UMARGAM" },
  { value: "VALSAD",               label: "VALSAD" },
  { value: "NAVSARI",              label: "NAVSARI" },
  { value: "SURAT",                label: "SURAT" },
  { value: "VADODARA",             label: "VADODARA" },
  { value: "DAHOD",                label: "DAHOD" },
  { value: "ZALOD",                label: "ZALOD" },
  { value: "BHILODA",              label: "BHILODA" },
  { value: "BANAS",                label: "BANAS" },
  { value: "JAMNAGAR",             label: "JAMNAGAR" },
  { value: "BHUJ (KUTCH)",         label: "BHUJ (KUTCH)" },
...
function TaxCollectionContent() {
  ...
  const [gjLadenWeight,   setGjLadenWeight]   = useState("");
  const [gjUnladenWeight, setGjUnladenWeight] = useState("");
  ...
  const handleGetDetails = async () => {
    ...
    try {
      ...
      if (d.grossVehicleWt)  setGjLadenWeight(d.grossVehicleWt);
      if (d.unladenWt)       setGjUnladenWeight(d.unladenWt);
  ...
  const handleConfirmPayment = () => {
    const params = new URLSearchParams({
      ...
      paymentMethod,
      permitType,
      gjMakerStatus: makerStatus,
      gjMvTax:    mvTax     || "0",
      gjPermitFee: permitFee || "0",
      taxFrom,
      taxTo,
  ...
  const handleReset = () => {
    ...
    setGjLadenWeight(""); setGjUnladenWeight(""); setSeatingCap(""); setSleeperCap("0"); setServiceType("");
    setTaxMode("DAILY"); setPermitType(""); setMakerStatus(""); setPaymentMethod("ONLINE");
  ...
  const handleGetPdf = async () => {
    ...
    const receiptNo = `GJT${yy}${mm}${dd2}${rand}`;
    ...
    try {
      ...
      const link = document.createElement("a"); link.href=`/api/receipt/${savedId}?state=GJ&download=1`; link.download=`receipt_${savedId}.pdf`; document.body.appendChild(link); link.click(); document.body.removeChild(link);
      ...
      <div className="cp-news-bar">
        <div className="container-fluid cp-news-scroll-wrap">
          <div className="cp-news-scroll">
            ...
            <strong className="cp-news-highlight">VAHAN GJ CP &lt;VEHICLE NO&gt;</strong>
            &nbsp;to 7738299899
          </div>
        </div>
      </div>
                ...
                <div className="ui-panel-content">
                  ...
                  <div className="ui-grid-row">
                    <div className="ui-grid-col-6">
                      ...
                      <input type="text" className="ui-inputtext" maxLength={10}
                        ...
                        autoComplete="off" placeholder="e.g. GJ01AB1234" />
                    </div>
                    <div className="ui-grid-col-6">
                      <div className="ui-grid-row">
                  ...
                  <div className="ui-grid-row">
                    <div className="ui-grid-col-6">
                      ...
                      <input type="text" className="ui-inputtext input-autofilled"
                        value={isGoodsVehicle ? gjLadenWeight : seatingCap}
                        onChange={(e) => isGoodsVehicle
                          ? setGjLadenWeight(e.target.value)
                    ...
                    <div className="ui-grid-col-6">
                      ...
                      <input type="text" className="ui-inputtext input-autofilled"
                        value={isGoodsVehicle ? gjUnladenWeight : sleeperCap}
                        onChange={(e) => isGoodsVehicle
                          ? setGjUnladenWeight(e.target.value)
                  ...
                  {/* Row 7b: Maker Status (GJ-specific) */}
                  <div className="ui-grid-row">
                    <div className="ui-grid-col-6">
                      <div className="field-label resp-label-section">
                        <label className="ui-outputlabel">Maker Status</label>
                      </div>
                      <div className="ui-selectonemenu">
                        <select value={makerStatus} onChange={(e) => setMakerStatus(e.target.value)}>
                          <option value=""></option>
                    ...
                    <div className="ui-grid-col-6"></div>
                  </div>
            ...
            <div className="cp-modal-body">
              <table className="datatable-panel-100">
                <tbody>
                  ...
                  <tr>
                    <td><span className="small-text-font">Maker Status</span></td>
                    <td><span className="small-text-font">:</span></td>
                    <td><span className="small-text-font">{makerStatus || "-"}</span></td>
                  </tr>
                  <tr>
