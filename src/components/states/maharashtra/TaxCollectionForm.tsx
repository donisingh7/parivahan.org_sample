...
const STATE_LABEL = maharashtraConfig.label;
...
function TaxCollectionContent() {
  ...
  const [mhLadenWeight,   setMhLadenWeight]   = useState("");
  const [mhUnladenWeight, setMhUnladenWeight] = useState("");
  ...
  const handleGetDetails = async () => {
    ...
    try {
      ...
      if (d.grossVehicleWt)  setMhLadenWeight(d.grossVehicleWt);
      if (d.unladenWt)       setMhUnladenWeight(d.unladenWt);
  ...
  const handleGetPdf = async () => {
    ...
    const receiptNo = `MHT${yy}${mm}${dd2}${rand}`;
    ...
    try {
      ...
      const link = document.createElement("a"); link.href=`/api/receipt/${savedId}?state=MH&download=1`; link.download=`receipt_${savedId}.pdf`; document.body.appendChild(link); link.click(); document.body.removeChild(link);
      ...
      <div className="cp-news-bar">
        <div className="container-fluid cp-news-scroll-wrap">
          <div className="cp-news-scroll">
            ...
            <strong className="cp-news-highlight">VAHAN MH CP &lt;VEHICLE NO&gt;</strong>
            &nbsp;to 7738299899
          </div>
        </div>
      </div>
                ...
                <div className="ui-panel-content">
                  ...
                  <div className="ui-grid-row">
                    <div className="ui-grid-col-6">
                      ...
                      <input type="text" className="ui-inputtext" maxLength={10}
                        ...
                        autoComplete="off" placeholder="e.g. MH14AB1234" />
                    </div>
                    <div className="ui-grid-col-6">
                      <div className="ui-grid-row">
                  ...
                  <div className="ui-grid-row">
                    <div className="ui-grid-col-6">
                      ...
                      <input type="text" className="ui-inputtext input-autofilled"
                        value={isGoodsVehicle ? mhLadenWeight : seatingCap}
                        onChange={(e) => isGoodsVehicle
                          ? setMhLadenWeight(e.target.value)
                    ...
                    <div className="ui-grid-col-6">
                      ...
                      <input type="text" className="ui-inputtext input-autofilled"
                        value={isGoodsVehicle ? mhUnladenWeight : sleeperCap}
                        onChange={(e) => isGoodsVehicle
                          ? setMhUnladenWeight(e.target.value)
