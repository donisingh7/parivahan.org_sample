...
import type { ReceiptData } from "@/lib/receipt/buildReceiptData";

// Re-export the unified type so existing imports of `ReceiptData` from this
// file keep working. The shape is produced by src/lib/receipt/buildReceiptData.ts.
export type { ReceiptData } from "@/lib/receipt/buildReceiptData";
...
function EmblemWatermark() {
  return (
    ...
    >
      ...
      <img
        src="/Images/Rajasthan-Transport-Department.png"
        alt=""
        style={{
          width: "260px",
          height: "auto",
...
// ── Styles (kept inline — receipt prints best with self-contained CSS) ──────
...
export default function RajasthanReceipt({ data }: { data: ReceiptData }) {
  return (
    <div
    ...
    >
      {/* Image emblem watermark + tiled text watermark */}
      <EmblemWatermark />
      ...
      >
        ...
        <div style={{ textAlign: "center", flex: 1, padding: "0 16px" }}>
          ...
          <div style={{ fontSize: "13px", marginTop: "2px" }}>Department of Transport</div>
          <div style={{ fontSize: "12px", marginTop: "2px" }}>Checkpost Tax e-Receipt</div>
        </div>
